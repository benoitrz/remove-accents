...
it('Empty string base case', () => {
    assert.deepStrictEqual(removeAccents(emptyString), emptyString);
});

it('Remove French accents', () => {
    assert.deepStrictEqual(removeAccents(frenchTextWithAccents), frenchTextWithoutAccents);
});

it('Remove Spanish accents', () => {
    assert.deepStrictEqual(removeAccents(spanishTextWithAccents), spanishTextWithoutAccents);
});